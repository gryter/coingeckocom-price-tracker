...
<p>
	...
	<option value="bitsharesx" <?php selected($instance['crypto'], 'bitsharesx'); ?>>BitShares</option>
	...
	<option value="darkcoin" <?php selected($instance['crypto'], 'darkcoin'); ?>>Darkcoin</option>
	...
	<option value="gridcoin" <?php selected($instance['crypto'], 'gridcoin'); ?>>Gridcoin</option>
	...
	<option value="mastercoin" <?php selected($instance['crypto'], 'mastercoin'); ?>>Mastercoin</option>
	...
	<option value="quarkcoin" <?php selected($instance['crypto'], 'quarkcoin'); ?>>Quark</option>
	...
	<option value="worldcoin" <?php selected($instance['crypto'], 'worldcoin'); ?>>Terracoin</option>
	<option value="worldcoin" <?php selected($instance['crypto'], 'worldcoin'); ?>>Ultracoin</option>
	<option value="worldcoin" <?php selected($instance['crypto'], 'worldcoin'); ?>>Unobtanium</option>
	<option value="worldcoin" <?php selected($instance['crypto'], 'worldcoin'); ?>>USDe</option>
	<option value="worldcoin" <?php selected($instance['crypto'], 'worldcoin'); ?>>VeriCoin</option>
	<option value="worldcoin" <?php selected($instance['crypto'], 'worldcoin'); ?>>Vertcoin</option>
	<option value="worldcoin" <?php selected($instance['crypto'], 'worldcoin'); ?>>Whitecoin</option>
	<option value="worldcoin" <?php selected($instance['crypto'], 'worldcoin'); ?>>Worldcoin</option>
	<option value="xc" <?php selected($instance['crypto'], 'xc'); ?>>XCurrency</option>
	...
	<option value="nexthorizon" <?php selected($instance['crypto'], 'nexthorizon'); ?>>Horizon</option>
	...
	<option value="cryptogenicbullion" <?php selected($instance['crypto'], 'cryptogenicbullion'); ?>>Crypto Bullion</option>
	...
	<option value="supernet" <?php selected($instance['crypto'], 'currency'); ?>>SuperNET</option>
